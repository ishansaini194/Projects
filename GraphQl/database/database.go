...
import (
	...
	"github.com/ishansaini194/Projects/graph/model"
...
func Connect() *DB {
	...
	// ✅ UPDATED (mongo.NewClient is deprecated)
...
func (db *DB) CreateJobListing(jobInfo model.CreateJobListingInput) *model.JobListing {
	...
	insertRes, err := jobCollec.InsertOne(ctx, bson.M{
		"title":       jobInfo.Title,
...
func (db *DB) UpdateJobListing(jobId string, jobInfo model.UpdateJobListingInput) *model.JobListing {
	...
	// ✅ UPDATED (SetReturnDocument enum)
